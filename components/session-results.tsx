          ...
          <section className="mt-5 grid gap-5 [&>*]:min-w-0 xl:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="space-y-5">
              ...
              <div className="surface p-5 sm:p-7"><p className="text-sm font-[700]">Fast facts</p><div className="mt-5 grid grid-cols-2 gap-3">{[
                { icon: Gauge, label: "Pace", value: `${result.wpm} WPM`, note: "140 target" },
                { icon: MessageCircleMore, label: "Fillers", value: `${result.fillerRate}/min`, note: `${Math.round(result.fillerRate * result.durationSeconds / 60)} total` },
                { icon: Eye, label: "Engagement", value: `${result.cameraEngagement}%`, note: "Medium confidence" },
